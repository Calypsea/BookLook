...
export default function Header() {
  ...
  const LoggedInDropdownMenu: any = (
    <Dropdown.Item href="https://calypsea.github.io/BookLook/#/login" onClick={logout} className="DropdownMenu">
      Log Out
    </Dropdown.Item>
  );

  const LoggedOutDropdownMenu: any = (
    <Dropdown.Item href="https://calypsea.github.io/BookLook/#/login" className="DropdownMenu">
      Login
    </Dropdown.Item>
  );
        ...
        <header className={`header${mode}`}>
          ...
          <div className="rightSideNavigation">
            ...
            <Dropdown id="dropDown">
              ...
              <Dropdown.Menu>
                <Dropdown.Item href="https://calypsea.github.io/BookLook/#/" className="DropdownMenu">
                  Home
                </Dropdown.Item>
                <Dropdown.Item href="https://calypsea.github.io/BookLook/#/about" className="DropdownMenu">
                  About
                </Dropdown.Item>
                <Dropdown.Item href="https://calypsea.github.io/BookLook/#/browse" className="DropdownMenu">
                  Browse
                </Dropdown.Item>
                <Dropdown.Item href="https://calypsea.github.io/BookLook/#/favourites" className="DropdownMenu">
                  Favourites
                </Dropdown.Item>
                {user ? LoggedInDropdownMenu : LoggedOutDropdownMenu}
              </Dropdown.Menu>
